...
```
cd existing_repo
git remote add origin https://git.uwaterloo.ca/k4tieu/cs346-project-fall-2023.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.uwaterloo.ca/k4tieu/cs346-project-fall-2023/-/settings/integrations)
